<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index_Mosaico.aspx.cs" Inherits="Politech3.Vista.Mosaico.index_Mosaico" %>
                    ...
                    <section class="tiles">
                        ...
                        <article class="style1">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP01" runat="server">Procesador Intel® Core™ i5-10500</asp:Label>
                                <div class="content">
                                    <asp:Label Id="Breve01" runat="server">Un gran rendimiento y un gran precio, la 10ma generacion te enamorara.</asp:Label>
                                </div>
                            </a>
                        </article>
                        <article class="style2">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                  <asp:Label ID="Lb_NomP02" runat="server">Procesador Intel® Core™ i9-12900K</asp:Label>
                                <div class="content">
                                    <asp:Label Id="Breve02" runat="server">Lo mas alto en tecnologia, para los amantes de los videojuegos y el trabajo
                        ...
                        <article class="style3">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                  <asp:Label ID="Lb_Nom03" runat="server">Asus Motherboard Intel Z590, Prime Z590-P</asp:Label>
                                <div class="content">
                                      <asp:Label Id="Breve03" runat="server">Haciendo un buen combo con un procesador de 10ma generacion esta tarjeta madre
                        ...
                        <article class="style4">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                  <asp:Label ID="Lb_NomP04" runat="server">Asus Tarjeta Madre H670 Intel, TUF Gaming H670-PRO WiFi D4</asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve04" runat="server">Haciendo un buen combo con un procesador de 12va generacion esta tarjeta madre
                        ...
                        <article class="style5">
                            <span class="image">
                                <asp:Image ID="Productos05" runat="server"
                                    ImageUrl="~/Vista/Mosaico/images/pic05.png" />
                            </span>
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                 <asp:Label ID="Lb_NomP05" runat="server">ZOTAC Gaming GeForce RTX 3050 Twin Edge OC</asp:Label>
                                <div class="content">
                                     <asp:Label ID="Breve05" runat="server">Para poder hacer todo lo que quieras sin preocupacion, 
                                         esta es tu opcion.
                                     </asp:Label>
                                </div>
                            </a>
                        ...
                        <article class="style6">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP06" runat="server">GeForce RTX 3080 Ti</asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve06" runat="server">La gama mas alta, para los que desean tener los mejores componentes mas nuevos
                                        del mercado.
                                     </asp:Label>
                                </div>
                            </a>
                        ...
                        <article class="style2">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                 <asp:Label ID="Lb_NomP07" runat="server">GeForce RTX 3080 Ti</asp:Label>
                                <div class="content">
                                    <p></p>
                                    <asp:Label ID="Breve07" runat="server">Excelente opción de RAM si buscas velocidad, 
                        ...
                        <article class="style3">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP08" runat="server">TEAMGROUP T-Force Delta TUF Gaming Alliance RGB</asp:Label>
                                <div class="content">
                                     <asp:Label ID="Breve08" runat="server">Tiene una capacidad y velocidad muy buena, 
                        ...
                        <article class="style1">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                ...
                                <asp:Label ID="Lb_NomP09" runat="server"> Asus Fuente de Poder 850W 
                                    ROG Strix 80+ Gold
                                </asp:Label>

                                <div class="content">
                                    <asp:Label ID="Breve09" runat="server">La tecnología 0dB te permite disfrutar de juegos 
                        ...
                        <article class="style5">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                ...
                                <asp:Label ID="Lb_NomP10" runat="server">EVGA Supernova 
                                    1300W G+, 80+ Gold
                                </asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve10" runat="server">Condensadores 100% japoneses + 
                        ...
                        <article class="style6">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                ...
                                <asp:Label ID="Lb_NomP011" runat="server">MSI MAG Core Liquid 240R V2 </asp:Label>
                                <div class="content">
                             
                                    <asp:Label ID="Breve11" runat="server">ALTA DISIPACIÓN TÉRMICA - Una vía de agua separada a través del radiador consigue
                        ...
                        <article class="style4">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP12" runat="server">
                                    Asus ROG Ryujin II
                                </asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve12" runat="server">Bomba Asetek de 7ma generación ofrece un enfriamiento excepcional y un ruido
                                        mínimo.
                                     </asp:Label>
                                </div>
                            </a>
                        ...
                        <article class="style1">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NumP13" runat="server">
                                   Kingston SSD A400 450GB
                                </asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve13" runat="server">Para aquellos que quieren experimentar una mejora clara de su PC, la SU630
                        ...
                        <article class="style2">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Ll_Nom014" runat="server">
                                   Kingston SSD A400 1920GB
                                </asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve14" runat="server">
                        ...
                        <article class="style3">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP15" runat="server">
                                   WD WD2003FZEX 2TB
                                </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve15" runat="server">Unidad de disco duro de rendimiento de escritorio de próxima generación diseñada
                        ...
                        <article class="style4">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                 <asp:Label ID="Lb_NomP16" runat="server">
                                  Western Digital Black 6000GB
                                </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Brve16" runat="server">Velocidad de giro de alto rendimiento a 7200 RPM, hasta 32 MB de caché e interfaz
                        ...
                        <article class="style5">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP17" runat="server">
                                  Cooler Master MasterBox, TD500
                                </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve17" runat="server">Maximiza las posibilidades – Espacioso diseño interior acomoda placas base ATX de
                        ...
                        <article class="style6">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                 <asp:Label ID="Lb_NomP18" runat="server">
                                      NZXT H710i
                                </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve18" runat="server">Las cajas ATX de torre media H710 y H710i son el sueño de un constructor con
                        ...
                        <article class="style2">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                     <asp:Label ID="Lb_NomP19" runat="server">
                                        HyperX Alloy Origins Core
                                     </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve19" runat="server">Teclado tenkeyless ultra compacto y robusto que cuenta con interruptores
                        ...
                        <article class="style3">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                 <asp:Label ID="Lb_NomP20" runat="server">
                                    Razer BlackWidow V3
                                 </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve20" runat="server">Siente la diferencia con el Razer BlackWidow V3: respaldado por su legado como
                        ...
                        <article class="style1">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                        <asp:Label ID="Lb_21" runat="server">
                                            Razer DeathAdder V2 Mini
                                        </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve21" runat="server">Derivado de la emblemática ergonomía DeathAdder, el DeathAdder V2 Mini es un
                        ...
                        <article class="style5">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                    <asp:Label ID="Lb_NomP22" runat="server">
                                            Razer Mamba Elite                                     
                                    </asp:Label>
                                <div class="content">
                                    <asp:Label ID="Breve22" runat="server">Obtenga más control con 9 botones programables, cada uno de los cuales se
                        ...
                        <article class="style6">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                   <asp:Label ID="Lb_NomP23" runat="server">
                                            HUAWEI Display- Monitor de 23.8"                                     
                                    </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve23" runat="server">Pantalla LCD que presenta biseles estrechos en tres lados y una apariencia
                        ...
                        <article class="style4">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                     <asp:Label ID="Lb_NomP24" runat="server">
                                           HUAWEI Mateview GT- Monitor Gaming de 34"                                     
                                    </asp:Label>
                                 
                                <div class="content">
                                    <asp:Label ID="Breve24" runat="server">Perfecta para divertirte con las últimas novedades en videjuegos. -Inmersión
                        ...
                        <article class="style1">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP25" runat="server">
                                           Logitech C920 HD Pro                                   
                                    </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve25" runat="server">Ofrezca su mejor imagen en videoconferencias y grabe sofisticados vídeos con la
                                        cámara Web C920s.
                                     </asp:Label>
                                </div>
                            </a>
                        ...
                        <article class="style2">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                  <asp:Label ID="Lb_NomP26" runat="server">
                                          OBSBOT - Cámara web Tiny PTZ                                 
                                    </asp:Label>
      
                                <div class="content">
                                    <asp:Label ID="Breve26" runat="server">
                        ...
                        <article class="style3">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                  <asp:Label ID="Lb_NomP27" runat="server">
                                         Status Audio CB-1                              
                                    </asp:Label>
                   
                                <div class="content">
                                    <asp:Label ID="Breve27" runat="server">Diseñado para profesionales de audio que viven de su oficio, los audífonos de
                        ...
                        <article class="style4">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP28" runat="server">
                                         SteelSeries Arctis 5 (2019 Edition)                              
                                    </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve28" runat="server">Un nuevo diseño de micrófono con una claridad incomparable y una mayor comodidad
                        ...
                        <article class="style5">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP29" runat="server">
                                      Poli-tech® Intel Core I7 16GB SSD 480GB Monitor 27"                                   
                                    </asp:Label>
                            
                                <div class="content">
                                    <asp:Label ID="Breve29" runat="server">Potentes gráficos Intel UHD 630 lo que proporcionan un rendimiento rápido, sin
                        ...
                        <article class="style6">
                            ...
                            <a href="/Vista/Mosaico/Pg_Mos_Phantom/generic.aspx">
                                <asp:Label ID="Lb_NomP30" runat="server">
                                         Poli-tech® TUF Geforce GTX 1650 Ryzen 5 3600 SSD 2TB Monitor 23.6"                          
                                    </asp:Label>
                                
                                <div class="content">
                                    <asp:Label ID="Breve30" runat="server">Eleva el nivel de tu juego con el procesador AMD Ryzen 5 3600 con 6 núcleos y 12
